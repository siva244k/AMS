...
<script language="text/javascript" src="ajax.js">
</script>
</head>
<body>
	...
	<center>
		...
		<form id="myform" action="ClassWiseAttendanceServlet" method="POST">
			<table cellpadding="2" cellspacing="2" border="4">
				...
				<tr>
					<td>Year</td>
					<td><select name="year"><option value="1">I</option>
							<option value="2">II</option>
							<option value="3">III</option>
							<option value="4">IV</option></select></td>
				</tr>
