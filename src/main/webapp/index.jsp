...
<body>
		...
		<div class="row">
			<div class="span8 offset2">
				...
				<p>
					...
					The sample code consists of a JSP (this page) and a <a href="hello">simple
						servlet</a>. Take a look around and then use Eclipse or the Command
					Line to deploy some changes.
				</p>

				<ul id="tab" class="nav nav-tabs">
					<li class="active"><a id="eclipse-instructions-tab"
						href="#eclipse-instructions" data-toggle="tab">Using Eclipse
							3.7</a></li>
					<li><a id="cli-instructions-tab" href="#cli-instructions"
						data-toggle="tab">Using Command Line</a></li>
				</ul>
				...
				<div class="tab-content">
					<div id="eclipse-instructions" class="instructions tab-pane active">
						...
						<div class="alert alert-warn">
							If you already created this app from the Heroku Eclipse Plugin,
							proceed to <a href="#step3">Step 3</a>. The following steps
							depends on the Heroku Eclipse plugin. If you do not have the
							Heroku Eclipse plugin installed and configured, follow a <a
								href="https://devcenter.heroku.com/articles/getting-started-with-heroku-eclipse#installation-and-setup"
								target="_blank">step-by-step guide</a> on Dev Center to install
							the plugin and configure the plugin in Eclipse.
						</div>

						<h2>Step 1.Configure Heroku Eclipse preferences</h2>
						<ol>
							<li>Open <code>Eclipse</code><i class="icon-chevron-right"></i>
							<code>Preferences</code></li>
							<li>Select <code>Heroku</code></li>
							<li>Enter your <code>Email</code> and <code>Password</code></li>
							<li>Click <code>Login</code>. If your login was successful,
								your Heroku API key would be populated in the <code>API
									Key</code> field.<br />
								...
								</div> <span class="screenshot"> <a href="#apiPreferences"
									data-toggle="modal"> <img
										src='https://template-app-instructions-screenshots.s3.amazonaws.com/eclipse/heroku_preferences.png'
										alt="setup api key" width="100"> <i class="icon-zoom-in"></i>
								</a>
							</span>
							</li>
							<li>In the SSH Key section, click <code>Generate</code> if
								you need to generate a new key. If you have previously generated
								and saved a SSH key is automatically loaded from the default
								location. If it is not in the default location, click <code>Load
									SSH Key</code><br />
							</li>
							<li>Click on <code>Add</code> to add your SSH Key to Heroku
								...
								</div> <span class="screenshot"> <a href="#sshkeyadd"
									data-toggle="modal"> <img
										src='https://template-app-instructions-screenshots.s3.amazonaws.com/eclipse/heroku_ssh_add.png'
										alt="Add SSH Key to Heroku" width="100" /> <i
						...
						<ol>
							<li>Open <code>File</code><i class="icon-chevron-right"></i>
							<code>Import</code> and expand the Heroku section
								...
								</div> <span class="screenshot"> <a href="#importAppSelect"
									data-toggle="modal"> <img
										src='https://template-app-instructions-screenshots.s3.amazonaws.com/eclipse/import_app_1.png'
										alt="Import App" width="100" /> <i class="icon-zoom-in"></i>
								</a>
							</span>

							</li>
							<li>Select <code>Existing Heroku Application</code><i
							...
							<li>Select <code>
								...
								</div> <span class="screenshot"> <a href="#importApp2"
									data-toggle="modal"> <img
										src='https://template-app-instructions-screenshots.s3.amazonaws.com/eclipse/import_app_2.png'
										alt="Create app from template" width="100" /> <i
										class="icon-zoom-in"></i>
								</a>
							</span>
							</li>
							<li>Choose <code>Auto detected project</code>
								...
								</div> <span class="screenshot"> <a href="#importApp3"
									data-toggle="modal"> <img
										src='https://template-app-instructions-screenshots.s3.amazonaws.com/eclipse/import_app_3.png'
										alt="Project Type selection" width="100" /> <i
										class="icon-zoom-in"></i>
								</a>
							</span>
							</li>
							<li>Click <code>Finish</code> to complete the import. The
								plugin will use <a href="http://www.eclipse.org/egit/">eGit</a>
								...
								</div> <span class="screenshot"> <a href="#importApp4"
									data-toggle="modal"> <img
										src='https://template-app-instructions-screenshots.s3.amazonaws.com/eclipse/create_app_template_4.png'
										alt="Local Project and Git Repository" width="100" /> <i
										class="icon-zoom-in"></i>
								</a>
							</span>
							</li>
						...
						<ol>
							...
							<li>Modify line 20 with: <code> out.write("Deployed
									first change!".getBytes()); </code>
							</li>
						</ol>

						<h2>Step 4. Deploy to Heroku</h2>
						<ol>
							<li>Right-click the project root and choose <code>Team</code>
								<i class="icon-chevron-right"></i> <code>Commit</code>
							</li>
							<li>Enter a commit message and click <code>Commit</code>
								...
								<div class="modal hide" id="commitChanges">
									...
									<div class="modal-body">
										<img
											src="https://s3.amazonaws.com/template-app-instructions-screenshots/eclipse/6-5-commit.png"
											alt="Commit Changes" />
									</div>
								</div> <span class="screenshot"> <a href="#commitChanges"
									data-toggle="modal"> <img
										src="https://s3.amazonaws.com/template-app-instructions-screenshots/eclipse/6-5-commit.png"
										alt="Commit Changes" width="100" /> <i class="icon-zoom-in"></i>
								</a>
							</span>
							</li>
							<li>Right-click the project root and choose <code>Team</code>
								<i class="icon-chevron-right"></i> <code>Push to Upstream</code></li>
							<li>Review the push results. At the bottom, a "... deployed
								to Heroku" message will appear.
								...
								</div> <span class="screenshot"> <a href="#pushResults"
									data-toggle="modal"> <img
										src="https://s3.amazonaws.com/template-app-instructions-screenshots/eclipse/6-8-push-result.png"
										alt="Push Results" width="100" /> <i class="icon-zoom-in"></i>
								</a>
							</span>
							</li>
						</ol>
						...
						<div class="hero-unit">
							...
							<p>You've just cloned, modified, and deployed a brand new
								app.</p>
							<a href="/hello" class="btn btn-primary btn-large">See your
								changes</a>

							<p style="margin-top: 20px">
								Learn more at the <a
									href="http://devcenter.heroku.com/categories/java">Heroku
									Dev Center</a>
							</p>
						</div>
					</div>
					...
					<div id="cli-instructions" class="instructions tab-pane">
						...
						<ol>
							<li>Install the <a href="http://toolbelt.heroku.com">Heroku
									Toolbelt</a>.
							</li>
							<li>Install <a href="http://maven.apache.org/download.html">Maven</a>.
							</li>
						</ol>

						<h2>Step 2. Login to Heroku</h2>
						<code>heroku login</code>
						<blockquote>Be sure to create, or associate an SSH
							key with your account.</blockquote>
						<pre>
  $ heroku login
  ...
  Authentication successful.</pre>
						...
						<code>
							git clone -o heroku git@heroku.com:
							<script>document.write(appname())</script>
							.git
						</code>
						...
						<ol>
							<li><script>document.write("<code>cd " + appname() + "</code>")</script>
							</li>
							<li>Open <code>src/main/java/com/example/HelloServlet.java</code>
